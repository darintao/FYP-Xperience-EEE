...
export class IntroPage {
  ...
  navNumber = 0;
  conversationContent = ["Hi, I am \\Prof. X/! In \\2008/, I developed the first Artificial Intelligent ‘\\Eccentra/’, to assist me in completing the \\time travelling theory/. With the help of ‘Eccentra’,  we finally developed the time-travelling machine and it garnered me a Nobel prize."
